...
\section{Need}
Discuss the problem or need that the XXX method addresses. Why was this
method developed? What gaps in knowledge or practice does it fill?
State the background issues of Conformal Prediction.



\section{Introduction to Conformal Prediction}
...
\subsection{Exsiting Applications}
Could you elaborate on the current application scenarios for conformal prediction? It's used in drug development and even crop discovery—the benefits are numerous!


\subsection{idea insight}
...
1.nonparametric estimates of prediction loss (cross-validation and the bootstrap “632 rule”) as well as Breiman’s out-of-bag error estimates for random forests

2.Covariance penalties, including Mallows’ Cp and the Akaike Information Criterion, are parametric methods discussed in Section 4 along with the related concept of degrees of freedom.
